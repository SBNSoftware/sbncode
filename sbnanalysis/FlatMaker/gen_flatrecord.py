...
try:
    ...
    print "and 'castxml v0_00_00_f20180122 -f Linux64bit+2.6-2.12 -z /cvmfs/nova.opensciencegrid.org/externals'"
    sys.exit(1)
...
#    sys.stderr.write(str(klass)+'\n')
    ...
    print '  ~'+pt+'();'
    print
    print '  void Fill(const caf::'+klass.name+'& sr);'
    print
    print 'protected:'
    ...
    for tn in vec_mems:
        ...
        if tn.is_array():
            inits += [tn.name+'_idx(0), '+tn.name+'_length(sizeof(caf::'+klass.name+'::'+tn.name+')/sizeof(*caf::'+klass.name+'::'+tn.name+'))']
        else:
    ...
    print 'void flat::'+pt+'::Fill(const caf::'+klass.name+'& sr)'
    print '{'
    for tn in basic_mems:
