////////////////////////////////////////////////////////////////////////
// Class:       MultiPartVertexBoosted
// Module Type: producer
// File:        MultiPartVertexBoosted_module.cc
//
// Generated at Tue Dec 13 15:48:59 2016 by Kazuhiro Terao using artmod
// Modified for boost by Joshua Berger
...
class MultiPartVertexBoosted : public art::EDProducer {
public:
    explicit MultiPartVertexBoosted(fhicl::ParameterSet const & p);
    // The destructor generated by the compiler is fine for classes
    // without bare pointers or other resource use.
    ~MultiPartVertexBoosted();

    // Plugins should not be copied or assigned.
    MultiPartVertexBoosted(MultiPartVertexBoosted const &) = delete;
    MultiPartVertexBoosted(MultiPartVertexBoosted &&) = delete;
    MultiPartVertexBoosted & operator = (MultiPartVertexBoosted const &) = delete;
    MultiPartVertexBoosted & operator = (MultiPartVertexBoosted &&) = delete;
...
void MultiPartVertexBoosted::abort(const std::string msg) const
{
    std::cerr << "\033[93m" << msg.c_str() << "\033[00m" << std::endl;
    throw std::exception();
}

MultiPartVertexBoosted::~MultiPartVertexBoosted()
{ }

MultiPartVertexBoosted::MultiPartVertexBoosted(fhicl::ParameterSet const & p)
: EDProducer(p)
...
// Initialize member data here.
{
    ...
    _gamma_beta_range = p.get<std::array<double,2> > ("GammaBetaRange");
...
void MultiPartVertexBoosted::beginRun(art::Run& run)
{
...
std::vector<size_t> MultiPartVertexBoosted::GenParticles() const {
...
void MultiPartVertexBoosted::GenPosition(double& x, double& y, double& z) {
...
void MultiPartVertexBoosted::GenBoost(double& bx, double& by, double& bz) {

    double gbmag = fFlatRandom->fire(_gamma_beta_range[0],_gamma_beta_range[1]);
...
std::array<double, 3U> MultiPartVertexBoosted::extractDirection() const {
    double px, py, pz;
...
void MultiPartVertexBoosted::GenMomentum(const PartGenParam& param, const double& mass, double& px, double& py, double& pz) {
...
void MultiPartVertexBoosted::produce(art::Event & e)
{
    ...
    GenBoost(bx,by,bz);
    if(_debug)
      std::cout << "Event Boost (" << bx << "," << by << "," << bz << ")" << std::endl;
...
DEFINE_ART_MODULE(MultiPartVertexBoosted)
