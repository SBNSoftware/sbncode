#include "icaruscode/WireMod/Utilities/WireMod_Utilities.hh"

//--- CalcROIProperties ---
sys::WireMod_Utility::ROIProperties_t sys::WireMod_Utility::CalcROIProperties(recob::Wire::RegionsOfInterest_t::datarange_t const& roi)
{
...
//--- GetTargetROIs ---
std::vector<std::pair<unsigned int, unsigned int>> sys::WireMod_Utility::GetTargetROIs(sim::SimEnergyDeposit const& shifted_edep, double offset)
{
...
//--- GetHitTargetROIs ---
std::vector<std::pair<unsigned int, unsigned int>> sys::WireMod_Utility::GetHitTargetROIs(recob::Hit const& hit)
{
  // initialize return value
  // the pairs are <channel number, tick time>
  std::vector<std::pair<unsigned int, unsigned int>> target_roi_vec;
...
void sys::WireMod_Utility::FillROIMatchedEdepMap(std::vector<sim::SimEnergyDeposit> const& edepVec, std::vector<recob::Wire> const& wireVec, double offset)
{
...
void sys::WireMod_Utility::FillROIMatchedHitMap(std::vector<recob::Hit> const& hitVec, std::vector<recob::Wire> const& wireVec)
{
  // clear the map in case it was already set
...
std::vector<sys::WireMod_Utility::SubROIProperties_t> sys::WireMod_Utility::CalcSubROIProperties(sys::WireMod_Utility::ROIProperties_t const& roi_properties, std::vector<const recob::Hit*> const& hitPtrVec)
{
  std::vector<sys::WireMod_Utility::SubROIProperties_t> subroi_properties_vec;
  sys::WireMod_Utility::SubROIProperties_t subroi_properties;
...
//--- MatchEdepsToSubROIs ---
std::map<sys::WireMod_Utility::SubROI_Key_t, std::vector<const sim::SimEnergyDeposit*>> sys::WireMod_Utility::MatchEdepsToSubROIs(std::vector<sys::WireMod_Utility::SubROIProperties_t> const& subROIPropVec, 
                                                                                                                  std::vector<const sim::SimEnergyDeposit*> const& edepPtrVec, double offset)
{
  ...
  std::map<int, sys::WireMod_Utility::TruthProperties_t> TrackIDMatchedPropertyMap;
...
sys::WireMod_Utility::TruthProperties_t sys::WireMod_Utility::CalcPropertiesFromEdeps(std::vector<const sim::SimEnergyDeposit*> const& edepPtrVec, double offset)
{
  ...
  sys::WireMod_Utility::TruthProperties_t edep_props;
  double total_energy_all = 0.0;
  sys::WireMod_Utility::ScaleValues_t scales_e_weighted[3];
...
sys::WireMod_Utility::ScaleValues_t sys::WireMod_Utility::GetScaleValues(sys::WireMod_Utility::TruthProperties_t const& truth_props, sys::WireMod_Utility::ROIProperties_t const& roi_vals)
{
  return GetScaleValues(truth_props,roi_vals.plane);
}

//--- GetScaleValues (ver 2) ---
sys::WireMod_Utility::ScaleValues_t sys::WireMod_Utility::GetScaleValues(sys::WireMod_Utility::TruthProperties_t const& truth_props, unsigned int const& plane)
{
  // initialize return
  sys::WireMod_Utility::ScaleValues_t scales;
  scales.r_Q     = 1.0;
  scales.r_sigma = 1.0;
...
//--- ModifyROI ---
void sys::WireMod_Utility::ModifyROI(std::vector<float> & roi_data,
                                    sys::WireMod_Utility::ROIProperties_t const& roi_prop,
                                    std::vector<sys::WireMod_Utility::SubROIProperties_t> const& subROIPropVec,
                                    std::map<sys::WireMod_Utility::SubROI_Key_t, sys::WireMod_Utility::ScaleValues_t> const& subROIScaleMap)
{
