...
namespace AnThreeBD {
  ...
  void CDgLgR(double (&CD)[6],double Ue4,double Umu4,double Ut4, int LeptonPDG);
  ...
  void AnisotropicThreeBodyDist(TLorentzVector &pnu,TLorentzVector &pm,TLorentzVector &pp,double m_HNL,double Ue4,double Umu4,double Ut4,int LeptonPDG,bool Majorana,double Pol);
