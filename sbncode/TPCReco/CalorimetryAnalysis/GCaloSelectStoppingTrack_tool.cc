...
class GCaloSelectStoppingTrack: public IGCaloSelectionTool {
public:

  GCaloSelectStoppingTrack(const fhicl::ParameterSet &p);
  ~GCaloSelectStoppingTrack() {}
...
GCaloSelectStoppingTrack::GCaloSelectStoppingTrack(const fhicl::ParameterSet &p):
...
bool GCaloSelectStoppingTrack::Select(const TrackInfo &t) {
...
DEFINE_ART_CLASS_TOOL(GCaloSelectStoppingTrack)
