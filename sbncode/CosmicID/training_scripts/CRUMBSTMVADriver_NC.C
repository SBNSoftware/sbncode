...
int CRUMBSTMVADriver_NC()
{
  ...
  TCut mycuts = "strstr(matchedType,\"Nu\") && !strstr(matchedType,\"DirtNu\") && matchedPurity > 0.8 && matchedCompleteness > 0.8 && ccnc == 1";
