...
namespace ana
{
  ...
  //----------------------------------------------------------------------
  double FitSinSq2Theta14Sterile::GetValue(const osc::IOscCalcAdjustable* osc) const
  {
    return util::sqr(sin(2*osc::DowncastToSterile(osc)->GetAngle(1,4)));
  }

  //----------------------------------------------------------------------
  void FitSinSq2Theta14Sterile::SetValue(osc::IOscCalcAdjustable* osc, double val) const
  {
  ...
  //----------------------------------------------------------------------
  double FitSinSq2Theta34Sterile::GetValue(const osc::IOscCalcAdjustable* osc) const
  {
    return util::sqr(sin(2*osc::DowncastToSterile(osc)->GetAngle(3,4)));
  }

  //----------------------------------------------------------------------
  void FitSinSq2Theta34Sterile::SetValue(osc::IOscCalcAdjustable* osc, double val) const
  {
