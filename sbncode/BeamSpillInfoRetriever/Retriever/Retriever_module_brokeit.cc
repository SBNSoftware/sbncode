...
class sbn::Retriever : public BNBRetriever {
public:
  ...
  // Required functions.
  void produces(art::ProducesCollector&);
  void process_fragment(const artdaq::Fragment &fragment);
...
void sbn::Retriever::produces(art::ProducesCollector& collector)
{
  collector.produces< std::vector< sbn::BeamSpillInfo >, art::InSubRun >();
}

void sbn::Retriever::process_fragment(const artdaq::Fragment &fragment)
{
