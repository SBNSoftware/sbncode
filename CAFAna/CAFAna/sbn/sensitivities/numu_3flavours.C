...
void numu_3flavours()
{
  ...
  calc->SetL(0.11);
  calc->SetTh23(M_PI/4);
  calc->SetDmsq32(2.45e-3); // make these explicit
  ...
  c1->SaveAs("3flavour/numu_plot1.pdf");
  ...
  c1->SaveAs("3flavour/numu_plot2.pdf");
  ...
  c1->SaveAs("3flavour/numu_plot3.pdf");
